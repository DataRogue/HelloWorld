...
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/box.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_box_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/button.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_button_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/button_arrow_down.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_button_arrow_down_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/button_arrow_left.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_button_arrow_left_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/button_arrow_right.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_button_arrow_right_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/button_arrow_up.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_button_arrow_up_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/button_thin.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_button_thin_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/button_toggle.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_button_toggle_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/check_box.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_check_box_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/check_mark.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_check_mark_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/chrome.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_chrome_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/chrome_flat.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_chrome_flat_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/chrome_inset.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_chrome_inset_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/chrome_light.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_chrome_light_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/dropdown_mark.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_dropdown_mark_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/finger_big.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_finger_big_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/finger_small.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_finger_small_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/hilight.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_hilight_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/invis.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_invis_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/minus_mark.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_minus_mark_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/plus_mark.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_plus_mark_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/radio.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_radio_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/radio_dot.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_radio_dot_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/swatch.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_swatch_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/tab.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_tab_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/tab_back.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_tab_back_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/images/tooltip_arrow.png") @:keep #if display private #end class __ASSET__flixel_flixel_ui_img_tooltip_arrow_png extends flash.display.BitmapData {}
@:file("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/xml/default_loading_screen.xml") @:keep #if display private #end class __ASSET__flixel_flixel_ui_xml_default_loading_screen_xml extends flash.utils.ByteArray {}
@:file("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/xml/default_popup.xml") @:keep #if display private #end class __ASSET__flixel_flixel_ui_xml_default_popup_xml extends flash.utils.ByteArray {}
@:file("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/xml/defaults.xml") @:keep #if display private #end class __ASSET__flixel_flixel_ui_xml_defaults_xml extends flash.utils.ByteArray {}
...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		id = "assets/data/events.json";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/data/player.json";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/images/bullets.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/darken_gui.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/HexTilesetv3.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/HumanModel.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/images-go-here.txt";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/images/paperdoll/human_arm.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/paperdoll/human_arm.pyxel";
		path.set (id, id);
		type.set (id, AssetType.BINARY);
		id = "assets/images/paperdoll/human_head.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/paperdoll/human_leg.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/paperdoll/human_leg.pyxel";
		path.set (id, id);
		type.set (id, AssetType.BINARY);
		id = "assets/images/paperdoll/human_torso.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/paperdoll/human_torso.pyxel";
		path.set (id, id);
		type.set (id, AssetType.BINARY);
		id = "assets/images/tempGui.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
...
@:file("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/xml/default_loading_screen.xml") #if display private #end class __ASSET__flixel_flixel_ui_xml_default_loading_screen_xml extends lime.utils.ByteArray {}
@:file("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/xml/default_popup.xml") #if display private #end class __ASSET__flixel_flixel_ui_xml_default_popup_xml extends lime.utils.ByteArray {}
@:file("/usr/local/lib/haxe/lib/flixel-ui/2,2,0/assets/xml/defaults.xml") #if display private #end class __ASSET__flixel_flixel_ui_xml_defaults_xml extends lime.utils.ByteArray {}
